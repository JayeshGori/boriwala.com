...
import { FiHome, FiGrid, FiPackage, FiMessageSquare, FiSettings, FiLogOut, FiX, FiUsers, FiBell, FiShoppingBag, FiTrendingUp, FiImage, FiStar, FiTarget, FiMail } from 'react-icons/fi';
...
const navItems = [
  ...
  { href: '/admin/price-alerts', label: 'Price Alerts', icon: FiTarget },
  { href: '/admin/notifications', label: 'Notifications', icon: FiBell },
  { href: '/admin/bulk-email', label: 'Bulk Email', icon: FiMail },
  { href: '/admin/prices', label: 'Market Prices', icon: FiTrendingUp },
